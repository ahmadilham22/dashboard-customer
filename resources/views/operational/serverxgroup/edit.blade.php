  ...
  <div class="main-content">
    <section class="section">
      <div class="section-header">
        ...
        <h1>@lang('app.edit') @lang('app.operational.serverxgroup')</h1>
        <div class="section-header-breadcrumb">
          <div class="breadcrumb-item active"><a href="#">@lang('app.operational.operational')</a></div>
          <div class="breadcrumb-item">@lang('app.edit') @lang('app.operational.serverxgroup')</div>
        </div>
      </div>
        ...
        <div class="row mt-4">
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                <form class="form" action="{{ route('operational.serverxgroup.update', $sxg->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="form-group row align-items-center">
                      ...
                      <div class="col-sm-6 col-md-9 col-lg-6">
                          <select name="id_group_server" class="form-control">
                              @foreach($group as $r)
                              <option value="{{$r->id_group_server}}" {{ $sxg->id_group_server  == $r->id_group_server ? 'selected' : ''}}>{{$r->nama_group}}</option>
                              @endforeach
                          </select>

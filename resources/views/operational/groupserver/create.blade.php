    ...
    <section class="section">
      <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
          ...
          <div class="breadcrumb-item">@lang('app.add') @lang('app.operational.group_server')</div>
        </div>
      </div>
        ...
        <div class="row mt-4">
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                <form class="form" action="{{ route('operational.groupserver.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-6 col-md-9 col-lg-6">
                            <input type="text" value="{{ old('nama_group') }}" name="nama_group" class="@error('nama_group') is-invalid @enderror form-control">
                            @error('nama_group')
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-6 col-md-9 col-lg-6">
                            <input type="text" value="{{ old('client') }}" name="client" class="@error('client') is-invalid @enderror form-control">
                            @error('client')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>

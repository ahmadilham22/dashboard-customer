...
<head>
  ...
  <title>Login &mdash; Kazee Inventory</title>
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="{{ asset('images/logo-kazee.png') }}" alt="logo" width="200" class="rounded">
            </div>
            ...
            <div class="simple-footer">
                Copyright &copy; 2021 <div class="bullet"></div> PT. Kazee Digital Indonesia
            </div>
          </div>
        </div>
      </div>

  ...
  <div class="main-content">
    <section class="section">
      <div class="section-header">
        ...
        <h1>@lang('app.add') @lang('app.copy_right')</h1>
        <div class="section-header-breadcrumb">
          <div class="breadcrumb-item active"><a href="#">@lang('app.assets')</a></div>
          <div class="breadcrumb-item">@lang('app.add') @lang('app.copy_right')</div>
        </div>
      </div>
        ...
        <div class="row mt-4">
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                <form class="form" action="{{ route('asset.copy-rights.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-6 col-md-9 col-lg-6">
                            <input type="text" value="{{ old('no') }}" name="no" class="@error('no') is-invalid @enderror form-control">
                            @error('no')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-6 col-md-9 col-lg-6">
                            <input type="number" value="{{ old('year') }}" min="0" name="year" class="@error('year') is-invalid @enderror form-control">
                            @error('year')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>

    ...
    <section class="section">
      <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
          ...
          <div class="breadcrumb-item">@lang('app.edit') {{ $product->name }}</div>
        </div>
      </div>
        ...
        <div class="row mt-4">
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                <form class="form" action="{{ route('asset.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-6 col-md-9 col-lg-6">
                            <textarea name="description" class="@error('description') is-invalid @enderror form-control" row="3">{{ old('description', $product->description) }}</textarea>
                            @error('description')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-6 col-md-9 col-lg-6">
                            <input type="text" value="{{ old('url', $product->url) }}" name="url" class="@error('url') is-invalid @enderror form-control">
                            @error('url')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-6 col-md-9 col-lg-6">
                            <input type="number" step="0.01" value="{{ old('debit', $product->debit) }}" name="debit" class="@error('debit') is-invalid @enderror form-control">
                            @error('debit')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-6 col-md-9 col-lg-6">
                            <input type="number" step="0.01" value="{{ old('credit', $product->credit) }}" name="credit" class="@error('credit') is-invalid @enderror form-control">
                            @error('credit')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-6 col-md-9 col-lg-6">
                            <input type="number" step="0.01" value="{{ old('value', $product->value) }}" name="value" class="@error('value') is-invalid @enderror form-control">
                            @error('value')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>

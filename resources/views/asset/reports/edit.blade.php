  ...
  <div class="main-content">
    <section class="section">
      <div class="section-header">
        ...
        <h1>@lang('app.edit') @lang('app.reports')</h1>
        <div class="section-header-breadcrumb">
          ...
          <div class="breadcrumb-item">@lang('app.edit') @lang('app.report') {{ optional($report->client)->name }}</div>
        </div>
      </div>
        ...
        <div class="row mt-4">
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                <form class="form" action="{{ route('asset.reports.update', $report->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-6 col-md-9 col-lg-6">
                            <select class="form-control" name="client_id" required="">
                                ...
                                <option value="{{$item->id}}" {{ old('client_id', $report->client_id) == $item->id ? 'selected' : ''}}>{{$item->name}}</option>
                                @endforeach
                            </select>
                            @error('client_id')
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-6 col-md-9 col-lg-6">
                            ...
                            <select class="form-control" name="type" required="">
                                ...
                                <option value="{{$item}}" {{ old('type', $report->type) == $item ? 'selected' : ''}}>{{$item}}</option>
                                @endforeach
                            </select>
                            @error('type')
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-6 col-md-9 col-lg-6">
                            <textarea name="description" class="@error('description') is-invalid @enderror form-control" row="3">{{ old('description', $report->description) }}</textarea>
                            @error('description')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-6 col-md-9 col-lg-6">
                            <input type="date" value="{{ old('start_date', $report->start_date) }}" name="start_date" class="@error('start_date') is-invalid @enderror form-control">
                            @error('start_date')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-6 col-md-9 col-lg-6">
                            <input type="date" value="{{ old('end_date', $report->end_date) }}" name="end_date" class="@error('end_date') is-invalid @enderror form-control">
                            @error('end_date')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>

  ...
  <div class="main-content">
    <section class="section">
      <div class="section-header">
        ...
        <h1>@lang('app.add') @lang('app.clipping_online')</h1>
        <div class="section-header-breadcrumb">
          <div class="breadcrumb-item active"><a href="#">@lang('app.assets')</a></div>
          <div class="breadcrumb-item">@lang('app.add') @lang('app.clipping_online')</div>
        </div>
      </div>
        ...
        <div class="row mt-4">
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                <form class="form" action="{{ route('asset.clipping-onlines.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <!-- CLIENT NAME -->
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-6 col-md-9 col-lg-6">
                            <input type="text" value="{{ old('date_news') }}" name="date_news" class="@error('date_news') is-invalid @enderror form-control daterange-picker" required="">
                            @error('date_news')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-6 col-md-9 col-lg-6">
                            <input type="text" value="{{ old('date') }}" name="date" class="@error('date') is-invalid @enderror form-control datepicker" required="">
                            @error('date')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-6 col-md-9 col-lg-6">
                            <textarea name="content" class="@error('content') is-invalid @enderror form-control summernote" row="15" required="">{{ old('content') }}</textarea>
                            @error('content')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
